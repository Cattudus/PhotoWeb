    ...
    if (width >= 900) {
        return (<div style={{height: '25vh'}}>
            ...
            <div style={{display: 'flex', justifyContent: 'center', paddingTop: '1rem',paddingLeft: '2rem'}}>
                <InstagramOutlined style={{paddingRight: '2rem', fontSize: '23px'}} href="https://www.instagram.com/mariquita_photography/"/>
        ...
        return (<div className="small-header">
            ...
            <div className="header-socials">
                <div style={{paddingRight: '0.5rem'}}>
                    <InstagramOutlined style={{fontSize: '21px'}} href="https://www.instagram.com/mariquita_photography/"/>
                </div>
                <div>
